...
Основная цель данного приложения: Пользователь отправляет любой вопрос, сервер возвращает наиболее похожий вопрос/ответ на основе обученных данных из БД.
